...
audio = Audio(audio_source, delay=3/30)

Multitrack([
    Clip(tracking, start="06:20"),
    Clip(pc_and_tracking, start="06:55"),
    Clip(tracking, start="08:40"),
    Clip(pc_and_tracking, start="10:15"),
    Clip(tracking, start="48:16"),
    Clip(pc_and_tracking, start="49:11", end="90:00")
